...
###############################################
browser.get('https://www.deadstock.ca/cart/39983863890005:1')
...
#If Captcha DNE, redirect to checkout page 1 fpr form filling
WebDriverWait(browser, 10).until(EC.visibility_of_element_located(("id", "checkout_email")))
